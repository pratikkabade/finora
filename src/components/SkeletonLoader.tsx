...
export const SkeletonCard2: React.FC = () => (
    <div className="glass-card hover:bg-white p-3 sm:p-2 md:p-3 transition-all duration-300 relative rounded-2xl fade-in2">
        <div className="flex flex-col xs:flex-row xs:justify-between xs:items-start gap-2 xs:gap-3 mb-2 xs:mb-3">
            <div className="flex-1 min-w-0">
                <div className='h-7 bg-slate-400 rounded-sm w-3/4 animate-pulse mb-2'></div>
                <div className='h-4 bg-slate-300 rounded-sm w-2/4 animate-pulse'></div>
            </div>
            <div className='h-7 bg-slate-400 rounded-lg w-2/5 animate-pulse'></div>
        </div>

        <div className="flex flex-wrap justify-around gap-1.5 sm:gap-2 text-xs max-sm:text-sm">
            <div className='h-6 bg-green-100 rounded-full w-1/5 animate-pulse'></div>
            <div className='h-6 bg-purple-100 rounded-full w-1/5 animate-pulse'></div>
        </div>
    </div>
)
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3 md:gap-4 mb-6">
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <button
                        ...
                        <div className='h-9 bg-slate-300 rounded-sm animate-pulse'></div>
                    </button>
            ...
            <div>
                <div className="flex flex-col xs:flex-row xs:items-center xs:justify-between gap-2 xs:gap-4 mb-4">
                    <div className="min-w-0">
                        ...
                        <p className="text-xs sm:text-sm text-gray-600 mt-0.5 sm:mt-1 flex flex-row items-center gap-1.5">Showing <div className='h-4 bg-slate-200 rounded-sm w-3 animate-pulse'></div> transaction</p>
                    </div>
                </div>
